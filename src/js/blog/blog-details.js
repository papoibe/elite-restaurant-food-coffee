            ...
            <div class="flex gap-4 ${c.isReply ? 'ml-8 md:ml-12' : ''}">
              ...
              <div>
                <div class="flex items-center gap-3 mb-1">
                  ...
                  <span class="text-xs text-primary cursor-pointer hover:underline inline-flex items-center gap-1"><svg class="w-2.5 h-2.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 17l-5-5 5-5M4 12h10a5 5 0 015 5v1"/></svg> Reply</span>
                </div>
